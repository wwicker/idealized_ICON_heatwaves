...
if __name__ == '__main__':
    ...
    xr.Dataset(dict(var167=percentiles)).to_netcdf(work+'/wolfgang/ERA5_surf_day_max/percentiles.nc')
    ...
    filenames = [work+'/wolfgang/ERA5_surf_day_max/heat_%d.json'%year[0] for year in groups]
